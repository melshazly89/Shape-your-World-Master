...
#define SW1                     (*((volatile unsigned long *)0x40025040))  //PF4 Address
#define out                      (*((volatile unsigned long *)0x40025038)) //PF3,2,1 Address
  ...
  while(1){
    // body goes here
		...
		if(SW1==0x00)
		{
			...
			out ^=0x04;   //PF2 Toggle when SW1 is pressed
			Delay100ms(1);
		}
		else if(SW1==0x10)
		{
