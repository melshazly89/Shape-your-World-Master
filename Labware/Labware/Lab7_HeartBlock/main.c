...
#define AS                      (*((volatile unsigned long *)0x40025040))   //PF4 Address
#define Ready                   (*((volatile unsigned long *)0x40025020))   //PF3 Address
#define VT                      (*((volatile unsigned long *)0x40025008))   //PF1 Address
...
void PortF_Init(void){ volatile unsigned long delay;
  ...
  GPIO_PORTF_DEN_R |= 0x0E;          // 4.2) PF3,2,1 output  
